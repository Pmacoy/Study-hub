...
import { knowledgeData } from '../../data/aws/knowledgeBase';
...
export default function AwsKnowledgeBase({ activeTab }: { activeTab: AwsTab }) {
    ...
    <div className="mt-12 space-y-6 animate-in fade-in duration-500">
      <section className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/70">
        <div className="border-b border-slate-800 px-5 py-5 md:px-6">
          <div className="flex items-start gap-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-orange-500/20 bg-orange-500/10 text-orange-300">
              <GraduationCap size={20} />
            </div>

            <div className="min-w-0">
              <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-orange-300">
                Knowledge base SAA-C03
              </p>
      ...
      <section className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        {domain.items.map((item, i) => (
          <article
            key={i}
            className="rounded-3xl border border-slate-800 bg-slate-950/70 p-5 transition-all hover:border-orange-500/20"
          >
            <div className="flex items-start gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-800 bg-slate-900 text-orange-300">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex shrink-0 items-center gap-1 rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 text-[12px] text-slate-300 transition-all hover:border-orange-500/20 hover:text-white"
                  >
                    Docs
